...
compile_arch() {
    ...
    case $arch in
        "armv4l"|"armv5l"|"armv6l"|"armv7l")
            CFLAGS="$CFLAGS -march=armv4t -mtune=arm9tdmi"
            ;;
        "mips"|"mipsel")
            CFLAGS="$CFLAGS -march=mips32 -mtune=mips32"
            ;;
        "i586")
            CFLAGS="$CFLAGS -march=i586 -mtune=i586"
            ;;
        "m68k")
            CFLAGS="$CFLAGS -march=m68k -mtune=m68k"
            ;;
        "powerpc")
            CFLAGS="$CFLAGS -march=powerpc -mtune=powerpc"
            ;;
        "sh4")
            ...
            ;;
        "sparc")
            CFLAGS="$CFLAGS -march=sparc -mtune=sparc"
            ;;
    esac
