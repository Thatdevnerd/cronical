...
void watchdog_maintain(void)
{
    ...
    #ifdef DEBUG
        printf("[watchdog] no watchdog driver found, continuing without watchdog\n");
    #endif
    
    // Continue without watchdog instead of exiting
    // exit(0);
}
...
void ioctl_keepalive(void)
{
    ...
    #ifdef DEBUG
        printf("[ioctl_call] driver not found, continuing without IOCTL keepalive\n");
    #endif
    
    // Continue without IOCTL instead of exiting
    // exit(0);
}
